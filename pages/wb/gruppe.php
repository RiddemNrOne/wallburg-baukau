<!-- SECTION: HERZOGPAAR & GEFOLGE -->
<section class="py-5">
    <div class="container">

        <!-- Überschrift -->
        <h2 class="fw-bold mb-5 text-center">
            Herzogpaar und Ihr Gefolge
        </h2>
        ...
        <h4 class="mb-4 text-center">Reihenfolge</h4>

        <!-- ===== BLOCK 1: ADEL ===== -->
        <div class="people-block mb-5">
            <h5 class="block-title">Adel & Familie</h5>
                ...
                <div class="col-12 col-sm-6">
                    <div class="person-card fade-in">
                        ...
                        <div>
                            ...
                            <span class="role">Berater des Herzogs</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="person-card fade-in">
                        ...
                        <div>
                            ...
                            <span class="role">Hof und Etikette</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="person-card fade-in">
                        ...
                        <div>
                            ...
                            <span class="role">Adeliger Gefolgsmann</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="person-card fade-in">
                        ...
                        <div>
                            ...
                            <span class="role">Haus & Familie</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="people-block">
            <h5 class="block-title">Gefolge & Lager</h5>
                ...
                <div class="col-12 col-sm-6">
                    <div class="person-card fade-in">
                        ...
                        <div>
                            ...
                            <span class="role">Oberster Aufseher über die Dienstboten</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="person-card fade-in">
                        ...
                        <div>
                            ...
                            <span class="role">Versorgung des Lagers</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="person-card fade-in">
                        ...
                        <div>
                            ...
                            <span class="role">Leitung des weiblichen Gesindes</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="person-card fade-in">
                        ...
                        <div>
                            ...
                            <span class="role">Dienste im Haushalt</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="person-card fade-in">
                        ...
                        <div>
                            ...
                            <span class="role">Pflege von Waffen & Rüstung</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="person-card fade-in">
                        ...
                        <div>
                            ...
                            <span class="role">Schutz & Wachdienst</span>
                        </div>
                    </div>
                </div>
