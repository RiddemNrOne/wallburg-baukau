...
<head>
    ...
    <title>Wallburg Baukau: Historisches</title>
    ...
    <link href="historisches.css" rel="stylesheet">
    ...
    <!-- Panel Script -->
    <script src="wb.panel.min.js" defer></script>
</head>
<body>
    <!-- Page Header -->
                    ...
                    <div id="wb_PanelMenu2" style="display:inline-block;width:63px;height:70px;z-index:0;">
                        ...
                        <div id="PanelMenu2_markup">
                            <ul role="menu">
                                ...
                                <li role="menuitem"><a href="./historisches.php" class="active"><i class="fa fa-graduation-cap fa-fw"></i><span>Historisches</span></a></li>
    ...
    <div id="wb_LayoutGrid2">
        <div id="LayoutGrid2">
            <div class="row">
                ...
                <div class="col-2">
                    <div id="wb_Text2">
                        <p style="color:#000000;font-family:Arial;font-size:17px;">
